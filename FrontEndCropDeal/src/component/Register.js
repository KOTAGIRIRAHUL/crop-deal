  ...
  render() {
    return (
      <div className="col-md-12">
        <div className="card card-container" style={{background:"gray",borderRadius:"25px"}}>
          <img
            src="https://www.safetyandhealthmagazine.com/ext/resources/images/news/agriculture/farmer4.jpg?height=635&t=1632403732&width=1200"
            alt="profile-img"
